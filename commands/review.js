    ...
    axios.get(this.url).then((response) => {
      ...
      reviews.forEach((review) => {
        ...
        let embed = new Discord.MessageEmbed()
          .addField(
            "Content",
            ` <a:DzOtaku:739561320969666642> ${description} .....`,
            false
          )
          .setAuthor(review.reviewer.username, review.reviewer.image_url)
          .setThumbnail(img)
          .addField(
            "<a:DzOtaku:739561320969666642> Overral",
            review.reviewer.scores.overall,
            true
          )
          .addField(
            "<a:DzOtaku:739561320969666642> Story",
            review.reviewer.scores.story,
            true
          )
          .addField(
            "<a:DzOtaku:739561320969666642> Animation",
            review.reviewer.scores.animation,
            true
          )
          .addField(
            "<a:DzOtaku:739561320969666642> Sound",
            review.reviewer.scores.sound,
            true
          )
          .addField(
            "<a:DzOtaku:739561320969666642> Enjoyment ",
            review.reviewer.scores.enjoyment,
            true
          )
          .addField(
            "<a:DzOtaku:739561320969666642> Written By",
            `${review.reviewer.username}`,
            true
          )
          .addField(
            "<a:DzOtaku:739561320969666642> Full Review Link",
            review.url,
            false
          );
        embeds.push(embed);
